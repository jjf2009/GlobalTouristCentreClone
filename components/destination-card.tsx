    ...
    <Card className="overflow-hidden group focus-within:ring-2 focus-within:ring-primary">
      ...
      <CardContent className="p-3 sm:p-4">
        <div className="flex items-start justify-between gap-2 mb-1.5 sm:mb-2">
          <h3 className="font-serif font-semibold text-card-foreground text-sm sm:text-base leading-tight">{title}</h3>
          <div
        ...
        <p className="text-muted-foreground text-xs sm:text-sm line-clamp-2 mb-2 sm:mb-3">{description}</p>
        {tags.length > 0 && (
