export const translations = {
  en: {
    ...
    destinations: {
      ...
      dayTripsSubtitle:
        "Perfect getaways for when you're short on time but big on adventure.",
  ...
  ru: {
    ...
    // Destinations
    destinations: {
      title: "Выберите Ваше Следующее Приключение",
      subtitle:
        "Исследуйте нашу подборку направлений, которые создадут воспоминания на всю жизнь.",
      domesticTitle: "Внутренние Туры",
      domesticSubtitle:
        "Исследуйте разнообразную красоту Индии с нашими избранными направлениями.",
      internationalTitle: "Международные Туры",
      internationalSubtitle:
        "Откройте экзотические направления по всему миру с нашими международными турами.",
      dayTripsTitle: "Однодневные Туры",
      dayTripsSubtitle:
        "Идеальные путешествия для тех, у кого мало времени, но много желания приключений.",
    ...
    // Luxury Destinations
    luxury: {
      heroTitle: "Туры в Дубай",
      discount: "Скидка до 35%",
      getDiscount: "Получите 35% скидку на тур в Дубай",
      bestPrice: "Гарантия Лучшей Цены",
      tailorMade: "Индивидуальные туры",
      personalConsultants: "Персональные Консультанты",
      flexibility: "Гибкость в Организации",
      recognised: "Признано Правительством Индии",
      exclusiveDestinations: "Эксклюзивные Направления Индии",
    },
    // Footer
    footer: {
      tagline:
  ...
  it: {
    ...
    destinations: {
      title: "Scegli la Tua Prossima Avventura",
      subtitle:
        "Esplora la nostra selezione di destinazioni che creeranno ricordi per tutta la vita.",
      domesticTitle: "Viaggi Nazionali",
      domesticSubtitle:
        "Esplora la bellezza diversa dell'India con le nostre destinazioni selezionate.",
      internationalTitle: "Viaggi Internazionali",
      internationalSubtitle:
        "Scopri destinazioni esotiche nel mondo con i nostri pacchetti internazionali.",
      dayTripsTitle: "Escursioni Giornaliere",
      dayTripsSubtitle:
        "Fughe perfette per chi ha poco tempo ma tanta voglia di avventura.",
  ...
  fr: {
    ...
    form: {
      ...
      privacyNote:
        "En cliquant sur 'Envoyez-moi des Devis', vous acceptez notre",
    ...
    destinations: {
      title: "Choisissez Votre Prochaine Aventure",
      subtitle:
        "Explorez notre sélection de destinations qui créeront des souvenirs pour toute la vie.",
      domesticTitle: "Voyages Nationaux",
      domesticSubtitle:
        "Explorez la beauté diverse de l'Inde avec nos destinations sélectionnées.",
      internationalTitle: "Voyages Internationaux",
      internationalSubtitle:
        "Découvrez des destinations exotiques dans le monde entier avec nos forfaits internationaux.",
      dayTripsTitle: "Excursions d'une Journée",
      dayTripsSubtitle:
        "Des escapades parfaites pour ceux qui manquent de temps mais pas d'aventure.",
      exploreTours: "Explorer les Tours",
      viewDetails: "Voir les Détails",
      viewMore: "Voir Plus",
      viewAllDestinations: "Toutes les Destinations",
      nights: "Nuits",
      days: "Jours",
    },
    // Curated Collections
    ...
    memories: {
      ...
      subtitle:
        "Un aperçu des moments inoubliables que nous avons aidé à créer.",
    },
    // About Page
    about: {
  ...
  de: {
    ...
    destinations: {
      title: "Wählen Sie Ihr Nächstes Abenteuer",
      subtitle:
        "Entdecken Sie unsere Auswahl an Reisezielen, die Erinnerungen fürs Leben schaffen.",
      domesticTitle: "Inlandsreisen",
      domesticSubtitle:
        "Entdecken Sie die vielfältige Schönheit Indiens mit unseren ausgewählten Zielen.",
      internationalTitle: "Internationale Reisen",
      internationalSubtitle:
        "Entdecken Sie exotische Ziele weltweit mit unseren internationalen Paketen.",
      dayTripsTitle: "Tagesausflüge",
      dayTripsSubtitle:
        "Perfekte Ausflüge für alle, die wenig Zeit aber viel Abenteuerlust haben.",
      exploreTours: "Touren Entdecken",
      viewDetails: "Details Ansehen",
      viewMore: "Mehr Anzeigen",
      viewAllDestinations: "Alle Reiseziele",
      nights: "Nächte",
      days: "Tage",
    },
    // Curated Collections
