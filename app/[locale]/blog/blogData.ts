...
export const blogSections: BlogSectionData[] = [
  {
    id: "radhanagar",
    ...
    paragraphs: [
      "Why not begin with one of the most famous names in the list?...",
      "The best shot you will get here is that of a sunset...",
      "Try low-angle shots with bare feet in frame...",
    ],
  },
  {
    id: "radhanagar",
