                        ...
                        <form className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            placeholder={form.destinationPlaceholder || "Countries/cities you want to visit"}
                                            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"
                                            required
                                        />
                                    </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            placeholder={page.datesPlaceholder || "Flexible or specific dates"}
                                            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"
                                        />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            required
                                        >
                                            <option value="">{page.durationPlaceholder || "Select Duration"}</option>
                                            <option value="3-5">{page.duration3to5 || "3-5 Days"}</option>
                                            <option value="6-8">{page.duration6to8 || "6-8 Days"}</option>
                                            <option value="9-12">{page.duration9to12 || "9-12 Days"}</option>
                                            <option value="13+">{page.duration13plus || "13+ Days"}</option>
                                        </select>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="number"
                                            min="1"
                                            placeholder={page.travelersPlaceholder || "Adults and children"}
                                            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"
                                            required
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent transition appearance-none bg-white"
                                        >
                                            <option value="">{page.budgetPlaceholder || "Select Budget Range"}</option>
                                            <option value="economy">{page.budgetEconomy || "Economy (₹15,000 - ₹30,000)"}</option>
                                            <option value="mid-range">{page.budgetMid || "Mid-Range (₹30,000 - ₹60,000)"}</option>
                                            <option value="luxury">{page.budgetLuxury || "Luxury (₹60,000+)"}</option>
                                            <option value="flexible">{page.budgetFlexible || "Flexible/Not Sure"}</option>
                                        </select>
                                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                            <ChevronDown className="h-4 w-4 text-gray-400" />
                                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        rows={4}
                                        placeholder={page.specialPlaceholder || "Dietary needs, accessibility requirements, special occasions, etc."}
                            ...
                            <p className="text-center text-sm text-gray-500 mt-4">
                                {page.privacyNote || "We respect your privacy. Your information will not be shared."}
                            </p>
                        </form>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 text-lg">
                            {page.faqSubtitle || "Answers to common questions about our customized tour packages."}
                        </p>
                    </div>
